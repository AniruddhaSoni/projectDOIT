    ...
    <Container fluid>
      ...
      <Form>
        ...
        <Form.Group className="mb-3" controlId="bpl">
          ...
          <Form.Control
            type="text"
            placeholder="परिवार बीपीएल में चयनित है या नहीं"
          ></Form.Control>
        </Form.Group>
        <Form.Group className="mb-3" controlId="foodSecurity">
          ...
          <Form.Control
            type="text"
            placeholder="परिवार खाद्य सुरक्षा योजना में लाभान्वित है या नहीं"
          ></Form.Control>
        </Form.Group>
        <Form.Group className="mb-3" controlId="migration">
          ...
          <Form.Control
            type="text"
            placeholder="परिवार में पलायन की स्थिति - हॉ/ना"
          ></Form.Control>
        </Form.Group>
